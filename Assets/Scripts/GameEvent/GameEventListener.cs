...
#endif
    [Tooltip("Just raise event once")] public bool once = false;

    [Tooltip("Delay before raise the event")] [Range(0, 10)]
    public float delay = 0;

    [Tooltip("Raise this event on start")] public bool autoPlay = false;
    [Space] public GameEvent GameEvent;
